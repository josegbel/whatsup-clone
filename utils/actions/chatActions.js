...
export const createChat = async (loggedInUserId, chatData) => {
  ...
  console.log("newChat created: ", JSON.stringify(newChat));
  console.log("newChat created with data: ", JSON.stringify(newChatData));
  ...
  console.log("New chat created with id: ", newChat.key);
  return newChat.key;
};
